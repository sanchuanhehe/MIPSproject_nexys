...
#
# Script generated by Vivado on Sun Apr 07 21:18:34 +0800 2024
...
#
# Usage        : InstrROM.sh
#                InstrROM.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                InstrROM.sh [-reset_run]
#                InstrROM.sh [-reset_log]
#                InstrROM.sh [-help]
#
...
# script info
echo -e "InstrROM.sh - Script generated by export_simulation (Vivado v2023.2.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./InstrROM.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L dist_mem_gen_v8_0_14 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot InstrROM xil_defaultlib.InstrROM xil_defaultlib.glbl -log elaborate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb InstrROM.wdb xsim.dir libdpi.so)
...
Usage: InstrROM.sh [-step]\n\
Usage: InstrROM.sh [-lib_map_path]\n\
Usage: InstrROM.sh [-reset_run]\n\
Usage: InstrROM.sh [-reset_log]\n\
Usage: InstrROM.sh [-keep_index]\n\
