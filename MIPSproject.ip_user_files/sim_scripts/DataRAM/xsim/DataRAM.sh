...
#
# Script generated by Vivado on Sun Apr 07 19:38:12 +0800 2024
...
# script info
echo -e "DataRAM.sh - Script generated by export_simulation (Vivado v2023.2.2 (64-bit)-id)\n"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L dist_mem_gen_v8_0_14 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot DataRAM xil_defaultlib.DataRAM xil_defaultlib.glbl -log elaborate.log
}
